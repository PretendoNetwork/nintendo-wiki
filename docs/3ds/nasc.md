...
| `apinfo`     | Information about the used Wi-Fi access point in the format `AA:BBBBBBBBBB`. Example `01:0000000000`. `AA` is the AP slot. `BBBBBBBBBB` comes from either [ACU_GetNZoneApNumService](https://www.3dbrew.org/wiki/ACU:GetNZoneApNumService) or [ACU_GetConnectingHotspotSubset](https://www.3dbrew.org/wiki/AC_Services) based on the result from [ACU_GetWifiStatus](https://github.com/devkitPro/libctru/blob/4e25fb1d6c2ea124a9011c4b65f76f2968a9fb97/libctru/include/3ds/services/ac.h#L33-L37) |
